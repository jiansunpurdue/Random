...
DIR="/DmesonAna/sl6ana/v1_pbpb_pp_pPb/CMSSW_5_3_20/src/UserCode/OpenHF/GenParticleTreeD0"
...
.x run_GenParticleTreeD0.C+($startFile, $endFile, "$filelist",$decaychannel)
.q
EOF
